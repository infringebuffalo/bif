...
$username = $db->real_escape_string(htmlentities(trim(POSTvalue('username')),ENT_COMPAT | ENT_HTML5, "UTF-8"));

if ($username == '')
    {
    log_message("forgotpassword failed - blank username");
    echo "<p>You didn't enter an e-mail address - please put it in the box immediately above the \"Send me a new password\" button</p>";
    }
    ...
    if ($data)
        ...
        echo "<p>No account named $username was found</p>";
        }
    }
